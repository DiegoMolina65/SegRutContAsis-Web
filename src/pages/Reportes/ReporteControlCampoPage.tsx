...
const ReporteControlCampoPage = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      fecha: dayjs(),
      nombreArchivo: `Reporte_Control_Campo_${dayjs().format("YYYY-MM-DD")}.pdf`,
    },
  });
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    try {
      ...
      await generarControlCampo(payload);
      ...
      >
        <Container maxWidth="md">
          <Box sx={{ mb: 4, textAlign: "center" }}>
            ...
            >
              Reporte de Control de Campo
            </Typography>
            <Typography
              variant="body1"
              sx={{ color: "#64748b", fontSize: "1rem" }}
            >
              Seleccione los filtros para generar el reporte de control de campo.
            </Typography>
          </Box>
...
export default ReporteControlCampoPage;