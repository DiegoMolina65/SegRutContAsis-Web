...
const ReporteVisitasRealizadasPage = () => {
  const { supervisores, vendedores } = useUsuariosData();
  const { generarVisitasRealizadas, loading } = useReportesActividad();
  ...
  const {
    ...
    defaultValues: {
      ...
      nombreArchivo: `Reporte_Visitas_Realizadas_${dayjs().format(
        "YYYY-MM"
      )}.pdf`,
    },
  });
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    try {
      ...
      await generarVisitasRealizadas(payload);
      ...
      >
        <Container maxWidth="md">
          <Box sx={{ mb: 4, textAlign: "center" }}>
            ...
            >
              Seleccione los filtros para generar el reporte de visitas
              realizadas.
            </Typography>
          </Box>
...
export default ReporteVisitasRealizadasPage;